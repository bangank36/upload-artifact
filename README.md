...
See [Storing workflow data as artifacts](https://github.com/actions/toolkit/blob/main/packages/artifact/README.md) for additional examples and tips.

See extra documentation for the [@actions/artifact](https://github.com/actions/toolkit/tree/main/packages/artifact) package that is used internally regarding certain behaviors and limitations.
